...
function setupScriptsJS() {
  ...
  const textos = {
    es: {
      ...
      rfoAdjunto: `<p>Estimado cliente, buen día.</p><p>En seguimiento a su petición, realizamos envío del RFO del incidente reportado.</p><p>Cualquier duda, inquietud o comentario, estamos a la orden. Saludos cordiales.</p>`,
      ...
      info: `<p>Estimado cliente, cordial saludo.</p><p>Para proceder con la creación del caso y garantizar una gestión adecuada, agradecemos nos indique el motivo específico por el cual se requiere abrir esta solicitud.</p><p>Quedamos atentos a su amable confirmación para continuar con el debido proceso.</p>`,
    ...
    en: {
      notificacion: `<p>Dear customer, good afternoon.</p><p>We inform you that we are proceeding with the closure of the ticket.</p><p>For any questions or comments, we remain at your service.</p><p>Best regards.</p>`,
      cerrado: `<p>Dear customer</p><p>Best regards</p><p>Ticket TTTTTT is currently closed on our end.</p><p>If you experience any issues or changes in the service, please let us know the type of failure and provide the necessary evidence to proceed with opening a new case.</p><p>We remain attentive to your comments</p>`,
      duplicado: `<p>Dear customer. Good day,</p><p>The review of the reported link is being carried out under ticket xxxx; we will provide updates as soon as possible.</p><p>We will proceed to close the corresponding ticket. However, we remain available for any other request or additional inquiry.</p>`,
      graficas: `<p>Dear customer, good afternoon.</p><p>We are proceeding with sending the requested graphs.</p><p>We are proceeding with the closure of the case.</p>`,
      cancelar: `<p>Dear all, good day.</p><p>We appreciate the information and regret the requested service cancellation.</p><p>We kindly ask you to direct this request to your assigned Sales area / KAM, who is already copied on this email and will provide the corresponding assistance.</p><p>We remain attentive to any other additional inquiries.</p>`,
      tipoAfectacion: `<p>Dear customer, greetings.</p><p>To proceed with the proper opening of the case, please indicate the type of impact you are experiencing with the service, either: Total Outage or Degradation.</p><p>With this information, we will be able to continue with the validations and provide the corresponding support.</p> <p>We remain attentive to your kind confirmation.</p> `,
      seguimiento: `<p>Good afternoon, dear @/team</p><p>We want to inform you that we have notified our engineer in charge, who will soon be sharing all the necessary details. We appreciate your patience and understanding while we work to provide you with the complete information.</p>`,
      rfoCanal: `<p>Dear customer</p><p>Thank you for contacting us. We inform you that requests related to RFO can be managed through the email noclatam@ufinet.com, where the corresponding team will provide the appropriate support.</p><p>Since your inquiry has been directed to the indicated channel, we will proceed to close this ticket. If you require further assistance, do not hesitate to contact us again.</p><p>We remain at your disposal.</p>`,
      rfoAdjunto: `<p>Dear customer, good day.</p><p>Following up on your request, we are sending the RFO for the reported incident.</p><p>For any questions, concerns, or comments, we remain at your service. Best regards.</p>`,
      rfo: `<p>Dear customer,</p><p>Following up on the case, we inform you that the RFO is being requested from the responsible area for sharing; please note that delivery takes 48 to 72 business hours.</p><p>We remain attentive to your comments,</p>`,
      construccion: `<p>Dear customer, we appreciate your communication.</p><p>Upon validating in our system, we have detected that ID IDIDIDIDID is currently in construction status. Please contact the Project Manager for more information about the link and to validate the service status. You can communicate directly via email CCCCCCCCCC.</p><p>Since this matter has been redirected, we will proceed to close the corresponding ticket. However, we remain available for any other request or additional inquiry.</p>`,
      torre: `<p>Dear customer, good day.</p><p>We inform you that your request has been escalated to maintenance personnel. As soon as we have more information about the progress, we will let you know.</p><p>We will keep you informed of any relevant updates and will contact you if we need additional information.</p><p>Thank you for your understanding and cooperation.</p><p>Best regards,</p>`,
      redComp: `<p>Dear customer, good day.</p><p>We inform you that according to our database, the service corresponds to the COMPLEMENTARY NETWORK; therefore, it is necessary to share the correctly filled template (attached Excel). Additionally, please attach tests performed by IFX and the TVR photographic record to proceed with the ticket escalation.</p>`,
      solicitarId: `<p>Dear customer,</p><p>We kindly request your support in providing more information about your requirement, service ID, or an old ticket, to proceed with the opening and resolution of the ticket. If you do not know the ID, please contact the sales area in charge of providing that information.</p>`,
      validarId: `<p>Dear customer, we appreciate your communication.</p><p>We inform you that upon validating in our system, we found that ID IDIDIDID is not registered. Please verify that the service ID is correct or provide an old ticket to proceed with the opening and resolution. If you do not know the ID, please contact the sales area in charge.</p>`,
      baja: `<p>Dear customer, we appreciate your communication.</p><p>We inform you that upon validating in our system, we found that ID IDIDIDID is in Cancelled status. Please verify that the ID is correct or contact the sales area.</p>`,
      adm: `<p>Dear customer, we wish you an excellent day,</p><p>Please contact the Sales area or your designated Project Manager directly. They are responsible for these types of requests and will provide the appropriate assistance and information.</p><p>We will proceed with the closure of the ticket. We remain available for any other request or additional inquiry.</p>`,
      operatividad: `<p>Dear customer, good day.</p><p>We request your support in validating the current status of the reported service and, if it is operational, please let us know if we can proceed with closing the ticket.</p><p>We remain attentive.</p>`,
      descarte: `<p>Dear IFX, good day.</p><p>Following up on your request, we inform you that upon validating the information provided, we did not find a photographic record of the equipment. We require your collaboration in sending us the photographic record to escalate with the corresponding area.</p>`,
      accesos: `<p>Dear customer, good day.</p><p>Following up on your request, we inform you that access has been authorized. You will find the corresponding information below:</p>`,
      credenciales: `<p>Dear customer, thank you for your communication. We have validated in our system that your company already has credentials to report incidents through the web portal. To access our portal, please visit: 👉 https://gestionticketing.ufinet.com/auth</p>`,
      crearCredenciales: `<p>Dear customer, greetings. We appreciate your communication and inform you that we have received your request. To carry out the necessary configurations, we will require a period of 72 hours for the web portal access management.</p>`,
      solicitaCredenciales: `<p>Good afternoon, we have received your request. We will require 72 hours for the process, but first, the following information is needed: Service ID, Company Name, Legal Name, Email, Phone, and Requestor's Name.</p>`,
      info: `<p>Dear customer, greetings, please indicate the specific reason why this request needs to be opened to proceed with the case creation.</p>`,
      panama: `<p>Good morning/afternoon/evening to all, dear customer, thank you for your communication, we will proceed to manage your request and will shortly inform you of the result.</p>`,
      reporte: `<p>Dear all, good afternoon, for the following request we require: Description, Date, Name, Address, Contact, Country, and City.</p>`,
      suspendido: `<p>Dear customer, thank you for your communication. Upon validating in our system, we have detected that ID IDIDIDIDID is currently in Suspended status. Please contact the Collections area.</p>`
    },
    pt: {
      notificacion: `<p>Prezado cliente, boa tarde.</p><p>Informamos que estamos procedendo com o fechamento do ticket. </p><p>Qualquer dúvida ou comentário, estamos à disposição.</p><p>Atenciosamente.</p>`,
      cerrado: `<p>Prezado cliente</p><p>Cordial saudação</p><p>Atualmente, o ticket TTTTTT encontra-se fechado por nossa parte.</p><p>Caso apresente algum tipo de afetação ou novidade no serviço, por favor, indique-nos o tipo de falha e os devidos descartes para procedermos com a criação de um novo caso.</p><p>Ficamos atentos aos seus comentários</p>`,
      duplicado: `<p>Prezado cliente. Bom dia,</p><p>Está sendo realizada a revisão do link reportado com o seguinte ticket xxxx; forneceremos atualizações o mais breve possível.</p><p>Procederemos com o fechamento do ticket correspondente. No entanto, permanecemos à sua disposição para qualquer outra solicitação ou consulta adicional.</p>`,
      graficas: `<p>Prezado cliente, boa tarde.</p><p>Procedemos com o envio dos gráficos solicitados.</p><p>Procedemos com o fechamento do caso.</p>`,
      cancelar: `<p>Prezados, bom dia.</p><p>Agradecemos a informação e lamentamos o cancelamento do serviço solicitado.</p><p>Solicitamos, por favor, que direcionem esta solicitação diretamente à área Comercial / KAM designado, que já se encontra em cópia neste e-mail e poderá fornecer a assistência correspondente.</p><p>Permanecemos atentos a qualquer outra consulta adicional.</p>`,
      tipoAfectacion: `<p>Prezado cliente, uma cordial saudação.</p><p>Para prosseguirmos com a devida abertura do caso, agradecemos que nos indique qual tipo de afetação está apresentando no serviço, seja: Queda total do serviço ou Degradação.</p><p>Com esta informação, poderemos continuar com as validações e fornecer o suporte correspondente.</p> <p>Ficamos atentos à sua amável confirmação.</p> `,
      seguimiento: `<p>Boa tarde, prezado/equipe @</p><p>Queremos informar que notificamos o nosso engenheiro encarregado, que em breve compartilhará todos os detalhes necessários. Agradecemos a sua paciência e compreensão enquanto trabalhamos para fornecer a informação completa.</p>`,
      rfoCanal: `<p>Prezado cliente</p><p>Obrigado por nos contatar. Informamos que as solicitações relacionadas ao RFO podem ser gerenciadas através do e-mail noclatam@ufinet.com, onde a equipe correspondente poderá fornecer o suporte adequado.</p><p>Dado que a sua consulta foi orientada ao canal indicado, procederemos com o fechamento deste ticket. Se precisar de assistência adicional, não hesite em nos contatar novamente.</p><p>Permanecemos à sua disposição.</p>`,
      rfoAdjunto: `<p>Prezado cliente, bom dia.</p><p>Em acompanhamento à sua petição, realizamos o envio do RFO do incidente reportado.</p><p>Qualquer dúvida, inquietação ou comentário, estamos à disposição. Atenciosamente.</p>`,
      rfo: `<p>Prezado cliente,</p><p>Em acompanhamento ao caso, informamos que o RFO está sendo solicitado à área encarregada para podermos compartilhá-lo; tenha em conta que o prazo de entrega é de 48 a 72 horas úteis.</p><p>Ficamos pendentes dos seus comentários,</p>`,
      construccion: `<p>Prezado cliente, agradecemos a sua comunicação.</p><p>Ao validar em nosso sistema, detectamos que o ID IDIDIDIDID encontra-se atualmente em estado de construção. Por favor, entre em contato com o Project Manager para obter mais informações sobre o link e validar o estado do serviço. Você pode se comunicar diretamente através do e-mail CCCCCCCCCC.</p><p>Dado que este assunto foi redirecionado, procederemos com o fechamento do ticket correspondente. No entanto, permanecemos à sua disposição para qualquer outra solicitação ou consulta adicional.</p>`,
      torre: `<p>Prezado cliente, bom dia.</p><p>Informamos que a sua solicitação foi escalada para a equipe de manutenção. Assim que tivermos mais informações sobre o progresso, avisaremos.</p><p>Manteremos você informado sobre qualquer atualização relevante e entraremos em contato caso precisemos de informações adicionais.</p><p>Agradecemos a sua compreensão e colaboração.</p><p>Atenciosamente,</p>`,
      redComp: `<p>Prezado cliente, bom dia.</p><p>Informamos que, de acordo com o nosso banco de dados, o serviço corresponde à REDE COMPLEMENTAR; portanto, é necessário que nos enviem a planilha devidamente preenchida (Excel em anexo). Adicionalmente, anexar os testes realizados pela IFX e o registro fotográfico TVR para prosseguirmos com a escalação do ticket.</p>`,
      solicitarId: `<p>Prezado cliente,</p><p>Solicitamos o seu amável apoio para nos fornecer mais informações sobre o seu requerimento, ID do serviço ou um ticket antigo, para assim prosseguirmos com a abertura e resolução do ticket. Caso não saiba o ID, favor entrar em contato com a área comercial encarregada de fornecer essa informação.</p>`,
      validarId: `<p>Prezado cliente, agradecemos a sua comunicação.</p><p>Informamos que, ao validar em nosso sistema, verificamos que o ID IDIDIDID não está registrado. Por favor, solicitamos que verifiquem se o ID do serviço está correto ou forneçam um ticket antigo para prosseguirmos com a abertura e resolução. Caso não saiba o ID, favor contatar a área comercial.</p>`,
      baja: `<p>Prezado cliente, agradecemos a sua comunicação.</p><p>Informamos que, ao validar em nosso sistema, verificamos que o ID IDIDIDID está em estado Cancelado. Por favor, solicitamos que verifiquem se o ID está correto ou entrem em contato com a área comercial.</p>`,
      adm: `<p>Prezado cliente, desejamos um excelente dia,</p><p>Solicitamos, por favor, que entre em contato diretamente com a área Comercial ou com o seu Project Manager designado. Eles são os responsáveis por este tipo de solicitação e poderão fornecer a assistência adequada e a informação necessária.</p><p>Procederemos com o fechamento do ticket. Permanecemos à sua disposição para qualquer outra solicitação ou consulta adicional.</p>`,
      operatividad: `<p>Prezado cliente, bom dia.</p><p>Solicitamos o seu apoio para validar o estado atual do serviço reportado e, caso esteja operacional, por favor, indique-nos se podemos proceder com o fechamento do ticket.</p><p>Ficamos atentos.</p>`,
      descarte: `<p>Prezado IFX, bom dia.</p><p>Em acompanhamento à sua solicitação, informamos que, ao validar as informações fornecidas, não encontramos o registro fotográfico do equipamento. Solicitamos a sua colaboração para nos enviar o descarte fotográfico para podermos escalar com a área correspondente.</p>`,
      accesos: `<p>Prezado cliente, bom dia.</p><p>Em acompanhamento à sua petição, informamos que os acessos foram autorizados. Abaixo, você encontrará as informações correspondentes:</p>`,
      credenciales: `<p>Prezado cliente, agradecemos a sua comunicação. Validamos em nosso sistema que a sua empresa já possui credenciais para gerar o relatório da sua incidência através do portal web. Para acessar o nosso portal, visite o link: 👉 https://gestionticketing.ufinet.com/auth</p>`,
      crearCredenciales: `<p>Prezado cliente, cordiais saudações. Agradecemos a sua comunicação e informamos que recebemos a sua solicitação. Para realizar as configurações necessárias, precisaremos de um prazo de 72 horas para a gestão de acesso ao portal web.</p>`,
      solicitaCredenciales: `<p>Boa tarde, recebemos a sua solicitação. Precisaremos de um prazo de 72 horas para o processo, mas antes são necessárias as seguintes informações: ID do serviço, Nome da empresa, Razão Social, E-mail, Telefone e Nome do solicitante.</p>`,
      info: `<p>Prezado cliente, cordiais saudações, agradecemos que nos indique o motivo específico pelo qual é necessário abrir esta solicitação para prosseguirmos com a criação do caso.</p>`,
      panama: `<p>Bom dia/boa tarde/boa noite a todos, prezado cliente, obrigado pela sua comunicação, procederemos com a gestão da sua solicitação e em breve informaremos o resultado.</p>`,
      reporte: `<p>Prezados, boa tarde, para a seguinte solicitação, precisamos de: Descrição, Data, Nome, Endereço, Contato, País e Cidade.</p>`,
